...
# ---------------------------------------------------------------------------
DEFAULT_SERVER   = r"myserver.com\DBPATH"  # e.g. "MYSERVER" or "MYSERVER\\SQLEXPRESS"
DEFAULT_DATABASE = "D123" # e.g. "master"
# VmWare LogInsight API defaults
LOGINSIGHT_URL = "https://myloginsight.com:8888"
LOGINSIGHT_USERNAME = "my_id"
